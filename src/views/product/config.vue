    ...
    <el-dialog :title="textMap[dialogStatus]" :visible.sync="dialogFormVisible">
      ...
      >
        ...
        >
          <el-col :span="11">
            <el-form-item
              :rules="[{required: true, message: '键名必填', trigger: ['change','blur']},{max:100,message:'长度不能超过100',trigger:'change'}]"
              :prop="'value.'+index+'.key'"
              style="margin-right:5px"
            >
              <el-input v-model.trim="param.key" placeholder="键名" clearable />
            </el-form-item>
          </el-col>
          <el-col :span="11">
            <el-form-item
            ...
            >
              <el-input v-model.trim="param.val" placeholder="键值" clearable />
            </el-form-item>
          </el-col>
          <el-col :span="2">
            <el-form-item>
...
export default {
  ...
  methods: {
    ...
    removeParam(param) {
      ...
      let len = this.temp.value.length;
      if (len > 1) {
