  ...
  <div class="login-container">
    ...
    <div class="footer-1">
      <div class="footer-top">
        <a href="http://www.cdzic.net">成都子程电子设备有限公司</a>提供技术支持
      </div>
      <div class="footer">
        copyright <a href="http://www.cdzic.net">© 2009 cdzic</a> all rights
        reserved.
      </div>
    </div>
    ...
    handleLogin() {
      ...
      this.$refs.loginForm.validate(valid => {
        if (valid) {
          ...
          this.loading = true;
          this.browser =
            (this.getBrowser() && this.getBrowser().browser) || "未知浏览器"; // 获取浏览器名
          this.version =
            (this.getBrowser() && this.getBrowser().version) ||
            "未知浏览器版本号"; // 获取浏览器版本
