<template>
  <div class="content">
    ...
    <div>
      ...
      <div class="item">
        杀菌：
        <el-button :type="device.disinfect===0?'primary':''" @click="btnClick(1,0)">紫外线</el-button>
        <el-button :type="device.disinfect===1?'primary':''" @click="btnClick(1,1)">等离子</el-button>
        <el-button :type="device.disinfect===2?'primary':''" @click="btnClick(1,2)">臭氧</el-button>
      </div>
      <div class="item">
        关机：
        <el-button :type="device.closeStatus===0?'primary':''" @click="btnClick(2,0)">手动模式</el-button>
        <el-button :type="device.closeStatus===1?'primary':''" @click="btnClick(2,1)">自动模式</el-button>
        <el-button :type="device.closeStatus===2?'primary':''" @click="btnClick(2,2)">定时模式</el-button>
      </div>
    </div>
  </div>
</template>
    ...
    btnClick(type, choose) {
      ...
      switch (type) {
        case 0: // 风机
          ...
          break
        case 1: // 杀菌
          this.device.disinfect = choose
          console.log(this.device)
          break
        case 2: // 关机模式
          this.device.closeStatus = choose
          break
      }
    },
    setClick(type) {
