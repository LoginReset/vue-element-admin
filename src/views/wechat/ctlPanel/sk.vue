...
<script>
import CtlPanel from '@/views/wechat/ctlPanel/sk/base'
import StatusSet from '@/views/wechat/ctlPanel/sk/statusSet'
import SysSet from '@/views/wechat/ctlPanel/sk/sysSet'
...
export default {
  ...
  components: { CtlPanel, SysSet, StatusSet },
  data() {
    return {
      activeName: 'first',
