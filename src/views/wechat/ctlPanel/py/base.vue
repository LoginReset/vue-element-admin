<template>
  <div class="content">
    ...
    <div>
      <div class="item">
        风机：
        <el-button :type="device.fjStatus===0?'primary':''" @click="btnClick(0,0)">关</el-button>
        <el-button :type="device.fjStatus===1?'primary':''" @click="btnClick(0,1)">低速</el-button>
        <el-button :type="device.fjStatus===2?'primary':''" @click="btnClick(0,2)">中速</el-button>
        <el-button :type="device.fjStatus===3?'primary':''" @click="btnClick(0,3)">高速</el-button>
      </div>
      <div class="item">
        水膜：
        <el-button :type="device.smStatus===1?'primary':''" @click="btnClick(1,1)">开</el-button>
        <el-button :type="device.smStatus===0?'primary':''" @click="btnClick(1,0)">关</el-button>
      </div>
      <div class="item">
        杀毒：
        <el-button :type="device.xdStatus===1?'primary':''" @click="btnClick(2,1)">开</el-button>
        <el-button :type="device.xdStatus===0?'primary':''" @click="btnClick(2,0)">关</el-button>
      </div>
      <div class="item">
        备用：
        <el-button :type="device.byStatus===1?'primary':''" @click="btnClick(3,1)">开</el-button>
        <el-button :type="device.byStatus===0?'primary':''" @click="btnClick(3,0)">关</el-button>
      </div>
      <div class="item">
        模式：
        <el-button :type="device.msStatus===1?'primary':''" @click="btnClick(4,1)">手动模式</el-button>
        <el-button :type="device.msStatus===0?'primary':''" @click="btnClick(4,0)">自动模式</el-button>
      </div>
      <el-popconfirm title="确定关机吗？" @onConfirm="btnClick(5,1)">
        <el-button slot="reference" :type="device.close===1?'danger':''">关机</el-button>
      </el-popconfirm>

      <!-- <div class="item">
        {{}}
        <el-button :type="device.close===1?'danger':''" @click="btnClick(4,1)">是</el-button>
        <el-button :type="device.close===0?'primary':''" @click="btnClick(4,0)">否</el-button>
      </div>-->
      <!-- <div class="item">
        强度：
    ...
    btnClick(type, choose) {
      ...
      switch (type) {
        case 0: // 风机
          ...
          break
        case 1: // 水膜
          this.device.smStatus = choose
          console.log(this.device)
          break
        case 2: // 杀毒
          this.device.xdStatus = choose
          break
        case 3: // 备用
          this.device.byStatus = choose
          break
        case 4: // 模式
          this.device.msStatus = choose
          break
        case 5: // 关机
          this.device.close = choose
