          ...
          <div class="tab-content">
            <div class="tc-item">
              ...
              <div class="tci-time">
                <div class="tcit-item">
                  ...
                  <div class="tciti-time" @click="setTime(0,0)">{{ g0i0 }}
                  </div>
                </div>
                <div class="tcit-item end-time">
                  <div class="tciti-text">结束时间</div>
                  <div class="tciti-time" @click="setTime(0,1)">{{ g0i1 }}
                  </div>
                </div>
              </div>
            </div>
            <div class="tc-item">
              ...
              <div class="tci-time">
                <div class="tcit-item">
                  <div class="tciti-text">开始时间</div>
                  <div class="tciti-time" @click="setTime(0,2)">{{ g0i2 }}
                  </div>
                </div>
                <div class="tcit-item end-time">
                  <div class="tciti-text">结束时间</div>
                  <div class="tciti-time" @click="setTime(0,3)">{{ g0i3 }}
                  </div>
                </div>
              </div>
            </div>
            <div class="tc-item">
              ...
              <div class="tci-time">
                <div class="tcit-item">
                  <div class="tciti-text">开始时间</div>
                  <div class="tciti-time" @click="setTime(0,4)">{{ g0i4 }}
                  </div>
                </div>
                <div class="tcit-item end-time">
                  <div class="tciti-text">结束时间</div>
                  <div class="tciti-time" @click="setTime(0,5)">{{ g0i5 }}
                  </div>
                </div>
              </div>
            </div>
...
export default {
  ...
  data() {
    return {
      ...
      xdDef: ['08', '00', '08', '30', '10', '00', '10', '30', '13', '00', '13', '30',
        '17', '00', '17', '30', '19', '00', '19', '30', '22', '00', '22', '30']// 消毒默认时段
    }
  },
  mounted() {
  ...
  methods: {
    ...
    tabsClick(name, title) { // name即index
    ...
    checkedTime() { // 检查结束时间
      for (let i = 0; i < this.device.xdTime.length / 4; i++) {
        ...
        if ((end1 === '00' && end2 === '00') || (begin1 === '00' && begin2 === '00')) {
          continue
        }
    ...
    setTime(gIndex, iIndex) { // 设置时间
      ...
      this.pickerTime = this.device.xdTime[iIndex * 2] + ':' + this.device.xdTime[iIndex * 2 + 1]
      // }
  ...
  computed: {
    ...
    g0i0: function() {
      if (this.device.xdTime && this.device.xdTime[0] && this.device.xdTime[1]) {
        return this.device.xdTime[0] + ':' + this.device.xdTime[1]
      }
      return '00:00'
    }, g0i1: function() {
      if (this.device.xdTime && this.device.xdTime[2] && this.device.xdTime[3]) {
        return this.device.xdTime[2] + ':' + this.device.xdTime[3]
      }
      return '00:00'
    }, g0i2: function() {
      if (this.device.xdTime && this.device.xdTime[4] && this.device.xdTime[5]) {
        return this.device.xdTime[4] + ':' + this.device.xdTime[5]
      }
      return '00:00'
    }, g0i3: function() {
      if (this.device.xdTime && this.device.xdTime[6] && this.device.xdTime[7]) {
        return this.device.xdTime[6] + ':' + this.device.xdTime[7]
      }
      return '00:00'
    }, g0i4: function() {
      if (this.device.xdTime && this.device.xdTime[8] && this.device.xdTime[9]) {
        return this.device.xdTime[8] + ':' + this.device.xdTime[9]
      }
      return '00:00'
    }, g0i5: function() {
      if (this.device.xdTime && this.device.xdTime[10] && this.device.xdTime[11]) {
        return this.device.xdTime[10] + ':' + this.device.xdTime[11]
      }
      return '00:00'
    }, g0i6: function() {
      if (this.device.xdTime && this.device.xdTime[12] && this.device.xdTime[13]) {
        return this.device.xdTime[12] + ':' + this.device.xdTime[13]
      }
      return '00:00'
    }, g0i7: function() {
      if (this.device.xdTime && this.device.xdTime[14] && this.device.xdTime[15]) {
        return this.device.xdTime[14] + ':' + this.device.xdTime[15]
      }
      return '00:00'
    }, g0i8: function() {
      if (this.device.xdTime && this.device.xdTime[16] && this.device.xdTime[17]) {
        return this.device.xdTime[16] + ':' + this.device.xdTime[17]
      }
      return '00:00'
    }, g0i9: function() {
      if (this.device.xdTime && this.device.xdTime[18] && this.device.xdTime[19]) {
        return this.device.xdTime[18] + ':' + this.device.xdTime[19]
      }
      return '00:00'
    }, g0i10: function() {
      if (this.device.xdTime && this.device.xdTime[20] && this.device.xdTime[21]) {
        return this.device.xdTime[20] + ':' + this.device.xdTime[21]
      }
      return '00:00'
    }, g0i11: function() {
      if (this.device.xdTime && this.device.xdTime[22] && this.device.xdTime[23]) {
